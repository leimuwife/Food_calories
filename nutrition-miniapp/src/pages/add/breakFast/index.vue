  ...
  <view class="page-container">
    <view class="header-card">
      <view class="header-content">
        <text class="header-title">早餐</text>
      ...
      <view class="calorie-summary">
        <text class="summary-label">{{ getDateLabel() }}早餐总热量</text>
    ...
    <scroll-view scroll-y class="food-scroll">
      ...
      <view v-else class="empty-state">
        ...
        <text class="empty-text">暂无早餐记录</text>
      </view>
    </scroll-view>
...
function handleAdd() {
  uni.navigateTo({ url: `/pages/add/breakFast/edit?mode=add&date=${selectedDate.value}` })
}

function handleEdit(item: DietItemVO) {
  uni.navigateTo({ url: `/pages/add/breakFast/edit?mode=edit&itemId=${item.id}&date=${selectedDate.value}` })
}
