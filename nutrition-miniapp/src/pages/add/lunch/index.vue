  ...
  <view class="page-container">
    <view class="header-card">
      ...
      <view class="calorie-summary">
        <text class="summary-label">今日午餐总热量</text>
...
function handleAdd() {
  uni.navigateTo({ url: '/pages/add/lunch/edit?mode=add' })
}

function handleEdit(item: FoodItem) {
  const foodItemStr = encodeURIComponent(JSON.stringify(item))
  uni.navigateTo({ url: `/pages/add/lunch/edit?mode=edit&foodItem=${foodItemStr}` })
}
</script>
