  ...
  <view class="page-container">
    <view class="header-card">
      ...
      <view class="calorie-summary">
        <text class="summary-label">{{ getDateLabel() }}夜宵总热量</text>
    ...
    <scroll-view scroll-y class="food-scroll">
      ...
      <view v-else class="empty-state">
        ...
        <text class="empty-text">暂无夜宵记录</text>
      </view>
    </scroll-view>
...
function handleAdd() {
  uni.navigateTo({ url: `/pages/add/snack/edit?mode=add&date=${selectedDate.value}` })
}

function handleEdit(item: DietItemVO) {
  uni.navigateTo({ url: `/pages/add/snack/edit?mode=edit&itemId=${item.id}&date=${selectedDate.value}` })
}
